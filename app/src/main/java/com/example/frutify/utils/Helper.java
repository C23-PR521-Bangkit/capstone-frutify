...
public class Helper {
    ...
    public static final String BASE_URL = "https://frutifyapishapi-v1-qvsopsldnq-uc.a.run.app/";
    public static final String BASE_URL_2 = "https://frutifyapis-v1-qvsopsldnq-uc.a.run.app/";
    ...
    public static String getFile(String filename){
        return BASE_URL_2 + "uploads?path=" + filename;
    }
